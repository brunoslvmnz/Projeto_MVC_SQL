...
public class JdbctemplateApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		int qteContatos = this.jdbcTemplate.queryForObject("select count(*) from contatos", Integer.class);
		String telefone = this.jdbcTemplate.queryForObject("select telefone from contatos where nome = 'Edson Angoti Júnior'", String.class);

		System.out.println("Quantidade de contatos: " + qteContatos);
		System.out.println("Telefone do Edson: " + telefone);
